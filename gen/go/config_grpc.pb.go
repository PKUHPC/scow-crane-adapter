...
func (UnimplementedConfigServiceServer) GetAvailablePartitions(context.Context, *GetAvailablePartitionsRequest) (*GetAvailablePartitionsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetAvailablePartitions not implemented")
}
...
func (UnimplementedConfigServiceServer) GetSummaryClusterInfo(context.Context, *GetSummaryClusterInfoRequest) (*GetSummaryClusterInfoResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetSummaryClusterInfo not implemented")
}
func (UnimplementedConfigServiceServer) GetClusterNodesInfo(context.Context, *GetClusterNodesInfoRequest) (*GetClusterNodesInfoResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetClusterNodesInfo not implemented")
}
func (UnimplementedConfigServiceServer) ListImplementedOptionalFeatures(context.Context, *ListImplementedOptionalFeaturesRequest) (*ListImplementedOptionalFeaturesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListImplementedOptionalFeatures not implemented")
}
