...
const file_job_proto_rawDesc = "" +
	...
	"\x06job_id\x18\x01 \x01(\rR\x05jobId2\x82\x06\n" +
	"\n" +
	"JobService\x12Z\n" +
	...
	"\x11SubmitScriptAsJob\x120.scow.scheduler_adapter.SubmitScriptAsJobRequest\x1a1.scow.scheduler_adapter.SubmitScriptAsJobResponseB\xb3\x01\n" +
