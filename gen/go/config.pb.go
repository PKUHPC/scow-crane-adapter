...
type Partition struct {
	...
	// gpu_type: 目前可能的值为 "nvidia" 、 "huawei.com/Ascend910"
	// AI在gpu分区用gpu训练时必填gpu_type
	// 华为的gpu卡支持特殊的框架 mindspore
	GpuType *string `protobuf:"bytes,8,opt,name=gpu_type,json=gpuType,proto3,oneof" json:"gpu_type,omitempty"`
	// vram: vram size in M
	VramMb *uint64 `protobuf:"varint,9,opt,name=vram_mb,json=vramMb,proto3,oneof" json:"vram_mb,omitempty"`
	// accelerator_descriptions: 加速器描述，如cuda 版本, 驱动版本等
	// 当前最多只允许设置两个值
	AcceleratorDescriptions []string `protobuf:"bytes,10,rep,name=accelerator_descriptions,json=acceleratorDescriptions,proto3" json:"accelerator_descriptions,omitempty"`
	// gpu_model: 具体的 gpu 型号，如 "RTX3090" 等
...
func (x *Partition) GetGpuType() string {
...
func (x *Partition) GetVramMb() uint64 {
	if x != nil && x.VramMb != nil {
		return *x.VramMb
	}
	return 0
}

func (x *Partition) GetAcceleratorDescriptions() []string {
	if x != nil {
		return x.AcceleratorDescriptions
	}
	return nil
}

func (x *Partition) GetGpuModel() string {
...
func (x *Partition) GetMaxAcceleratorsPerPod() uint32 {
	if x != nil && x.MaxAcceleratorsPerPod != nil {
...
type PartitionInfo struct {
	...
	TotalMemMb          uint32                        `protobuf:"varint,19,opt,name=total_mem_mb,json=totalMemMb,proto3" json:"total_mem_mb,omitempty"`
	AllocMemMb          uint32                        `protobuf:"varint,20,opt,name=alloc_mem_mb,json=allocMemMb,proto3" json:"alloc_mem_mb,omitempty"`
	// accelerator_descriptions: 加速器描述，如cuda 版本, 驱动版本等
	// 当前最多只允许设置两个值
	AcceleratorDescriptions []string `protobuf:"bytes,21,rep,name=accelerator_descriptions,json=acceleratorDescriptions,proto3" json:"accelerator_descriptions,omitempty"`
	// gpu_model: 具体的 gpu 型号，如 "RTX3090" 等
	GpuModel      *string `protobuf:"bytes,22,opt,name=gpu_model,json=gpuModel,proto3,oneof" json:"gpu_model,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *PartitionInfo) GetTotalMemMb() uint32 {
	if x != nil {
		return x.TotalMemMb
	}
	return 0
...
func (x *PartitionInfo) GetAllocMemMb() uint32 {
	if x != nil {
		return x.AllocMemMb
	}
	return 0
...
func (x *PartitionInfo) GetAcceleratorDescriptions() []string {
	if x != nil {
		return x.AcceleratorDescriptions
	}
	return nil
...
func (x *PartitionInfo) GetGpuModel() string {
	if x != nil && x.GpuModel != nil {
		return *x.GpuModel
	}
	return ""
...
const file_config_proto_rawDesc = "" +
	...
	"\acomment\x18\a \x01(\tH\x00R\acomment\x88\x01\x01\x12\x1e\n" +
	"\bgpu_type\x18\b \x01(\tH\x01R\agpuType\x88\x01\x01\x12\x1c\n" +
	"\avram_mb\x18\t \x01(\x04H\x02R\x06vramMb\x88\x01\x01\x129\n" +
	...
	"\x10partition_status\x18\x12 \x01(\x0e25.scow.scheduler_adapter.PartitionInfo.PartitionStatusR\x0fpartitionStatus\x12 \n" +
	"\ftotal_mem_mb\x18\x13 \x01(\rR\n" +
	"totalMemMb\x12 \n" +
	"\falloc_mem_mb\x18\x14 \x01(\rR\n" +
	"allocMemMb\x129\n" +
	"\x18accelerator_descriptions\x18\x15 \x03(\tR\x17acceleratorDescriptions\x12 \n" +
	"\tgpu_model\x18\x16 \x01(\tH\x00R\bgpuModel\x88\x01\x01\"3\n" +
	"\x0fPartitionStatus\x12\x11\n" +
	"\rNOT_AVAILABLE\x10\x00\x12\r\n" +
	"\tAVAILABLE\x10\x01B\f\n" +
	"\n" +
	"_gpu_model\"\x17\n" +
