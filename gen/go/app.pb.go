...
const (
	...
	AppType_APP_TYPE_JUPYTER_LAB AppType = 1
	AppType_APP_TYPE_VSCODE      AppType = 2
)
...
var (
	AppType_name = map[int32]string{
		...
		1: "APP_TYPE_JUPYTER_LAB",
		2: "APP_TYPE_VSCODE",
	}
	AppType_value = map[string]int32{
		"APP_TYPE_UNSPECIFIED": 0,
		"APP_TYPE_JUPYTER_LAB": 1,
		"APP_TYPE_VSCODE":      2,
	}
)
...
type GetAppConnectionInfoRequest struct {
	...
	AppType       *AppType               `protobuf:"varint,2,opt,name=app_type,json=appType,proto3,enum=scow.scheduler_adapter.AppType,oneof" json:"app_type,omitempty"`
...
func (x *GetAppConnectionInfoRequest) GetAppType() AppType {
...
const file_app_proto_rawDesc = "" +
	"\n" +
	"\tapp.proto\x12\x16scow.scheduler_adapter\"\x82\x01\n" +
	"\x1bGetAppConnectionInfoRequest\x12\x15\n" +
	"\x06job_id\x18\x01 \x01(\rR\x05jobId\x12?\n" +
	"\bapp_type\x18\x02 \x01(\x0e2\x1f.scow.scheduler_adapter.AppTypeH\x00R\aappType\x88\x01\x01B\v\n" +
	"\t_app_type\"\x9e\x03\n" +
	...
	"\bresponse*R\n" +
	"\aAppType\x12\x18\n" +
	"\x14APP_TYPE_UNSPECIFIED\x10\x00\x12\x18\n" +
	"\x14APP_TYPE_JUPYTER_LAB\x10\x01\x12\x13\n" +
	"\x0fAPP_TYPE_VSCODE\x10\x022\x90\x01\n" +
	"\n" +
...
var file_app_proto_goTypes = []any{
	(AppType)(0),                                               // 0: scow.scheduler_adapter.AppType
	(*GetAppConnectionInfoRequest)(nil),                        // 1: scow.scheduler_adapter.GetAppConnectionInfoRequest
	(*GetAppConnectionInfoResponse)(nil),                       // 2: scow.scheduler_adapter.GetAppConnectionInfoResponse
	(*GetAppConnectionInfoResponse_UseJobScriptGenerated)(nil), // 3: scow.scheduler_adapter.GetAppConnectionInfoResponse.UseJobScriptGenerated
	(*GetAppConnectionInfoResponse_AppConnectionInfo)(nil),     // 4: scow.scheduler_adapter.GetAppConnectionInfoResponse.AppConnectionInfo
}
var file_app_proto_depIdxs = []int32{
	0, // 0: scow.scheduler_adapter.GetAppConnectionInfoRequest.app_type:type_name -> scow.scheduler_adapter.AppType
	3, // 1: scow.scheduler_adapter.GetAppConnectionInfoResponse.use_job_script_generated:type_name -> scow.scheduler_adapter.GetAppConnectionInfoResponse.UseJobScriptGenerated
	4, // 2: scow.scheduler_adapter.GetAppConnectionInfoResponse.app_connection_info:type_name -> scow.scheduler_adapter.GetAppConnectionInfoResponse.AppConnectionInfo
	1, // 3: scow.scheduler_adapter.AppService.GetAppConnectionInfo:input_type -> scow.scheduler_adapter.GetAppConnectionInfoRequest
	2, // 4: scow.scheduler_adapter.AppService.GetAppConnectionInfo:output_type -> scow.scheduler_adapter.GetAppConnectionInfoResponse
