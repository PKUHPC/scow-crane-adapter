...
func (x *StreamTaskIORequest_CranedTaskOutputReq) GetMsg() []byte {
	if x != nil {
		return x.Msg
	}
	return nil
...
func (x *StreamTaskIOReply_CranedTaskInputReq) GetMsg() []byte {
	if x != nil {
		return x.Msg
	}
	return nil
...
const file_Crane_proto_rawDesc = "" +
	...
	"\x03msg\x18\x02 \x01(\fR\x03msg\x1a>\n" +
	...
	"\atask_id\x18\x01 \x01(\rR\x06taskId\x12\x10\n" +
	"\x03msg\x18\x02 \x01(\fR\x03msg\x1a2\n" +
	...
	"\x14not_modified_reasons\x18\x03 \x03(\tR\x12notModifiedReasons2\xdd\x12\n" +
	"\tCraneCtld\x12H\n" +
	"\n" +
	...
	"\x16EnableAutoPowerControl\x12).crane.grpc.EnableAutoPowerControlRequest\x1a'.crane.grpc.EnableAutoPowerControlReply\x12H\n" +
	"\n" +
	...
	"\x10PowerStateChange\x12#.crane.grpc.PowerStateChangeRequest\x1a!.crane.grpc.PowerStateChangeReply2\xfb\x02\n" +
	...
	"\fCforedStream\x12\x1f.crane.grpc.StreamCforedRequest\x1a\x1b.crane.grpc.StreamCtldReply(\x010\x012\xe9\x06\n" +
	"\x06Craned\x12G\n" +
	...
	"\x13QueryTaskIdFromPort\x12&.crane.grpc.QueryTaskIdFromPortRequest\x1a$.crane.grpc.QueryTaskIdFromPortReply\x12i\n" +
	"\x15QueryTaskEnvVariables\x12(.crane.grpc.QueryTaskEnvVariablesRequest\x1a&.crane.grpc.QueryTaskEnvVariablesReply2\xf6\x02\n" +
	"\fCranedForPam\x12x\n" +
	...
	"\x16MigrateSshProcToCgroup\x12).crane.grpc.MigrateSshProcToCgroupRequest\x1a'.crane.grpc.MigrateSshProcToCgroupReply\x12~\n" +
...
var file_Crane_proto_msgTypes = make([]protoimpl.MessageInfo, 135)
var file_Crane_proto_goTypes = []any{
	...
	(*PowerStateChangeRequest)(nil),                    // 101: crane.grpc.PowerStateChangeRequest
	(*PowerStateChangeReply)(nil),                      // 102: crane.grpc.PowerStateChangeReply
	(*EnableAutoPowerControlRequest)(nil),              // 103: crane.grpc.EnableAutoPowerControlRequest
	(*EnableAutoPowerControlReply)(nil),                // 104: crane.grpc.EnableAutoPowerControlReply
	nil,                                                // 105: crane.grpc.ConfigureCranedRequest.JobMapEntry
	nil,                                                // 106: crane.grpc.ConfigureCranedRequest.JobTasksMapEntry
	nil,                                                // 107: crane.grpc.QueryTaskEnvVariablesReply.EnvMapEntry
	nil,                                                // 108: crane.grpc.QueryTaskEnvVariablesForwardReply.EnvMapEntry
	(*StreamCallocRequest_TaskReq)(nil),                // 109: crane.grpc.StreamCallocRequest.TaskReq
	(*StreamCallocRequest_TaskCompleteReq)(nil),        // 110: crane.grpc.StreamCallocRequest.TaskCompleteReq
	(*StreamCallocReply_TaskIdReply)(nil),              // 111: crane.grpc.StreamCallocReply.TaskIdReply
	(*StreamCallocReply_TaskResAllocatedReply)(nil),    // 112: crane.grpc.StreamCallocReply.TaskResAllocatedReply
	(*StreamCallocReply_TaskCancelRequest)(nil),        // 113: crane.grpc.StreamCallocReply.TaskCancelRequest
	(*StreamCallocReply_TaskCompletionAckReply)(nil),   // 114: crane.grpc.StreamCallocReply.TaskCompletionAckReply
	(*StreamCforedRequest_CforedReg)(nil),              // 115: crane.grpc.StreamCforedRequest.CforedReg
	(*StreamCforedRequest_TaskReq)(nil),                // 116: crane.grpc.StreamCforedRequest.TaskReq
	(*StreamCforedRequest_TaskCompleteReq)(nil),        // 117: crane.grpc.StreamCforedRequest.TaskCompleteReq
	(*StreamCforedRequest_GracefulExitReq)(nil),        // 118: crane.grpc.StreamCforedRequest.GracefulExitReq
	(*StreamCtldReply_TaskIdReply)(nil),                // 119: crane.grpc.StreamCtldReply.TaskIdReply
	(*StreamCtldReply_TaskResAllocatedReply)(nil),      // 120: crane.grpc.StreamCtldReply.TaskResAllocatedReply
	(*StreamCtldReply_TaskCancelRequest)(nil),          // 121: crane.grpc.StreamCtldReply.TaskCancelRequest
	(*StreamCtldReply_TaskCompletionAckReply)(nil),     // 122: crane.grpc.StreamCtldReply.TaskCompletionAckReply
	(*StreamCtldReply_CforedRegistrationAck)(nil),      // 123: crane.grpc.StreamCtldReply.CforedRegistrationAck
	(*StreamCtldReply_CforedGracefulExitAck)(nil),      // 124: crane.grpc.StreamCtldReply.CforedGracefulExitAck
	(*StreamCrunRequest_TaskReq)(nil),                  // 125: crane.grpc.StreamCrunRequest.TaskReq
	(*StreamCrunRequest_TaskCompleteReq)(nil),          // 126: crane.grpc.StreamCrunRequest.TaskCompleteReq
	(*StreamCrunRequest_TaskIOForwardReq)(nil),         // 127: crane.grpc.StreamCrunRequest.TaskIOForwardReq
	(*StreamCrunRequest_TaskX11ForwardReq)(nil),        // 128: crane.grpc.StreamCrunRequest.TaskX11ForwardReq
	(*StreamCrunReply_TaskIdReply)(nil),                // 129: crane.grpc.StreamCrunReply.TaskIdReply
	(*StreamCrunReply_TaskResAllocatedReply)(nil),      // 130: crane.grpc.StreamCrunReply.TaskResAllocatedReply
	(*StreamCrunReply_TaskCancelRequest)(nil),          // 131: crane.grpc.StreamCrunReply.TaskCancelRequest
	(*StreamCrunReply_TaskCompletionAckReply)(nil),     // 132: crane.grpc.StreamCrunReply.TaskCompletionAckReply
	(*StreamCrunReply_TaskIOForwardReadyReply)(nil),    // 133: crane.grpc.StreamCrunReply.TaskIOForwardReadyReply
	(*StreamCrunReply_TaskIOForwardReply)(nil),         // 134: crane.grpc.StreamCrunReply.TaskIOForwardReply
	(*StreamCrunReply_TaskX11ForwardReply)(nil),        // 135: crane.grpc.StreamCrunReply.TaskX11ForwardReply
	(*StreamTaskIORequest_CranedRegisterReq)(nil),      // 136: crane.grpc.StreamTaskIORequest.CranedRegisterReq
	(*StreamTaskIORequest_CranedTaskOutputReq)(nil),    // 137: crane.grpc.StreamTaskIORequest.CranedTaskOutputReq
	(*StreamTaskIORequest_CranedUnRegisterReq)(nil),    // 138: crane.grpc.StreamTaskIORequest.CranedUnRegisterReq
	(*StreamTaskIORequest_CranedTaskX11OutputReq)(nil), // 139: crane.grpc.StreamTaskIORequest.CranedTaskX11OutputReq
	(*StreamTaskIOReply_CranedRegisterReply)(nil),      // 140: crane.grpc.StreamTaskIOReply.CranedRegisterReply
	(*StreamTaskIOReply_CranedTaskInputReq)(nil),       // 141: crane.grpc.StreamTaskIOReply.CranedTaskInputReq
	(*StreamTaskIOReply_CranedUnregisterReply)(nil),    // 142: crane.grpc.StreamTaskIOReply.CranedUnregisterReply
	(*StreamTaskIOReply_CranedTaskX11InputReq)(nil),    // 143: crane.grpc.StreamTaskIOReply.CranedTaskX11InputReq
	(TaskStatus)(0),                                    // 144: crane.grpc.TaskStatus
	(*timestamppb.Timestamp)(nil),                      // 145: google.protobuf.Timestamp
	(*CranedRemoteMeta)(nil),                           // 146: crane.grpc.CranedRemoteMeta
	(*TaskToCtld)(nil),                                 // 147: crane.grpc.TaskToCtld
	(ErrCode)(0),                                       // 148: crane.grpc.ErrCode
	(*TaskToD)(nil),                                    // 149: crane.grpc.TaskToD
	(*JobToD)(nil),                                     // 150: crane.grpc.JobToD
	(*CranedInfo)(nil),                                 // 151: crane.grpc.CranedInfo
	(*PartitionInfo)(nil),                              // 152: crane.grpc.PartitionInfo
	(*ReservationInfo)(nil),                            // 153: crane.grpc.ReservationInfo
	(CranedControlState)(0),                            // 154: crane.grpc.CranedControlState
	(*AccountInfo)(nil),                                // 155: crane.grpc.AccountInfo
	(*UserInfo)(nil),                                   // 156: crane.grpc.UserInfo
	(*QosInfo)(nil),                                    // 157: crane.grpc.QosInfo
	(*RichError)(nil),                                  // 158: crane.grpc.RichError
	(ModifyField)(0),                                   // 159: crane.grpc.ModifyField
	(OperationType)(0),                                 // 160: crane.grpc.OperationType
	(EntityType)(0),                                    // 161: crane.grpc.EntityType
	(CranedResourceState)(0),                           // 162: crane.grpc.CranedResourceState
	(CranedPowerState)(0),                              // 163: crane.grpc.CranedPowerState
	(*TrimmedPartitionInfo)(nil),                       // 164: crane.grpc.TrimmedPartitionInfo
	(*TimeInterval)(nil),                               // 165: crane.grpc.TimeInterval
	(*TaskInfo)(nil),                                   // 166: crane.grpc.TaskInfo
	(InteractiveTaskType)(0),                           // 167: crane.grpc.InteractiveTaskType
	(*emptypb.Empty)(nil),                              // 168: google.protobuf.Empty
}
var file_Crane_proto_depIdxs = []int32{
	144, // 0: crane.grpc.TaskStatusChangeRequest.new_status:type_name -> crane.grpc.TaskStatus
	145, // 1: crane.grpc.CranedTriggerReverseConnRequest.token:type_name -> google.protobuf.Timestamp
	105, // 2: crane.grpc.ConfigureCranedRequest.job_map:type_name -> crane.grpc.ConfigureCranedRequest.JobMapEntry
	106, // 3: crane.grpc.ConfigureCranedRequest.job_tasks_map:type_name -> crane.grpc.ConfigureCranedRequest.JobTasksMapEntry
	145, // 4: crane.grpc.ConfigureCranedRequest.token:type_name -> google.protobuf.Timestamp
	146, // 5: crane.grpc.CranedRegisterRequest.remote_meta:type_name -> crane.grpc.CranedRemoteMeta
	145, // 6: crane.grpc.CranedRegisterRequest.token:type_name -> google.protobuf.Timestamp
	147, // 7: crane.grpc.SubmitBatchTaskRequest.task:type_name -> crane.grpc.TaskToCtld
	148, // 8: crane.grpc.SubmitBatchTaskReply.code:type_name -> crane.grpc.ErrCode
	147, // 9: crane.grpc.SubmitBatchTasksRequest.task:type_name -> crane.grpc.TaskToCtld
	148, // 10: crane.grpc.SubmitBatchTasksReply.code_list:type_name -> crane.grpc.ErrCode
	149, // 11: crane.grpc.ExecuteTasksRequest.tasks:type_name -> crane.grpc.TaskToD
	150, // 12: crane.grpc.CreateCgroupForTasksRequest.job_list:type_name -> crane.grpc.JobToD
	144, // 13: crane.grpc.CancelTaskRequest.filter_state:type_name -> crane.grpc.TaskStatus
	151, // 14: crane.grpc.QueryCranedInfoReply.craned_info_list:type_name -> crane.grpc.CranedInfo
	152, // 15: crane.grpc.QueryPartitionInfoReply.partition_info_list:type_name -> crane.grpc.PartitionInfo
	153, // 16: crane.grpc.QueryReservationInfoReply.reservation_info_list:type_name -> crane.grpc.ReservationInfo
	0,   // 17: crane.grpc.ModifyTaskRequest.attribute:type_name -> crane.grpc.ModifyTaskRequest.TargetAttributes
	154, // 18: crane.grpc.ModifyCranedStateRequest.new_state:type_name -> crane.grpc.CranedControlState
	155, // 19: crane.grpc.AddAccountRequest.account:type_name -> crane.grpc.AccountInfo
	148, // 20: crane.grpc.AddAccountReply.code:type_name -> crane.grpc.ErrCode
	156, // 21: crane.grpc.AddUserRequest.user:type_name -> crane.grpc.UserInfo
	148, // 22: crane.grpc.AddUserReply.code:type_name -> crane.grpc.ErrCode
	157, // 23: crane.grpc.AddQosRequest.qos:type_name -> crane.grpc.QosInfo
	148, // 24: crane.grpc.AddQosReply.code:type_name -> crane.grpc.ErrCode
	158, // 25: crane.grpc.DeleteAccountReply.rich_error_list:type_name -> crane.grpc.RichError
	158, // 26: crane.grpc.DeleteUserReply.rich_error_list:type_name -> crane.grpc.RichError
	158, // 27: crane.grpc.DeleteQosReply.rich_error_list:type_name -> crane.grpc.RichError
	159, // 28: crane.grpc.ModifyAccountRequest.modify_field:type_name -> crane.grpc.ModifyField
	160, // 29: crane.grpc.ModifyAccountRequest.type:type_name -> crane.grpc.OperationType
	158, // 30: crane.grpc.ModifyAccountReply.rich_error_list:type_name -> crane.grpc.RichError
	159, // 31: crane.grpc.ModifyUserRequest.modify_field:type_name -> crane.grpc.ModifyField
	160, // 32: crane.grpc.ModifyUserRequest.type:type_name -> crane.grpc.OperationType
	158, // 33: crane.grpc.ModifyUserReply.rich_error_list:type_name -> crane.grpc.RichError
	159, // 34: crane.grpc.ModifyQosRequest.modify_field:type_name -> crane.grpc.ModifyField
	148, // 35: crane.grpc.ModifyQosReply.code:type_name -> crane.grpc.ErrCode
	155, // 36: crane.grpc.QueryAccountInfoReply.account_list:type_name -> crane.grpc.AccountInfo
	158, // 37: crane.grpc.QueryAccountInfoReply.rich_error_list:type_name -> crane.grpc.RichError
	156, // 38: crane.grpc.QueryUserInfoReply.user_list:type_name -> crane.grpc.UserInfo
	158, // 39: crane.grpc.QueryUserInfoReply.rich_error_list:type_name -> crane.grpc.RichError
	157, // 40: crane.grpc.QueryQosInfoReply.qos_list:type_name -> crane.grpc.QosInfo
	158, // 41: crane.grpc.QueryQosInfoReply.rich_error_list:type_name -> crane.grpc.RichError
	161, // 42: crane.grpc.BlockAccountOrUserRequest.entity_type:type_name -> crane.grpc.EntityType
	158, // 43: crane.grpc.BlockAccountOrUserReply.rich_error_list:type_name -> crane.grpc.RichError
	148, // 44: crane.grpc.ModifyPartitionAclReply.code:type_name -> crane.grpc.ErrCode
	107, // 45: crane.grpc.QueryTaskEnvVariablesReply.env_map:type_name -> crane.grpc.QueryTaskEnvVariablesReply.EnvMapEntry
	108, // 46: crane.grpc.QueryTaskEnvVariablesForwardReply.env_map:type_name -> crane.grpc.QueryTaskEnvVariablesForwardReply.EnvMapEntry
	162, // 47: crane.grpc.QueryClusterInfoRequest.filter_craned_resource_states:type_name -> crane.grpc.CranedResourceState
	154, // 48: crane.grpc.QueryClusterInfoRequest.filter_craned_control_states:type_name -> crane.grpc.CranedControlState
	163, // 49: crane.grpc.QueryClusterInfoRequest.filter_craned_power_states:type_name -> crane.grpc.CranedPowerState
	164, // 50: crane.grpc.QueryClusterInfoReply.partitions:type_name -> crane.grpc.TrimmedPartitionInfo
	144, // 51: crane.grpc.QueryTasksInfoRequest.filter_task_states:type_name -> crane.grpc.TaskStatus
	165, // 52: crane.grpc.QueryTasksInfoRequest.filter_submit_time_interval:type_name -> crane.grpc.TimeInterval
	165, // 53: crane.grpc.QueryTasksInfoRequest.filter_start_time_interval:type_name -> crane.grpc.TimeInterval
	165, // 54: crane.grpc.QueryTasksInfoRequest.filter_end_time_interval:type_name -> crane.grpc.TimeInterval
	166, // 55: crane.grpc.QueryTasksInfoReply.task_info_list:type_name -> crane.grpc.TaskInfo
	1,   // 56: crane.grpc.StreamCallocRequest.type:type_name -> crane.grpc.StreamCallocRequest.CallocRequestType
	109, // 57: crane.grpc.StreamCallocRequest.payload_task_req:type_name -> crane.grpc.StreamCallocRequest.TaskReq
	110, // 58: crane.grpc.StreamCallocRequest.payload_task_complete_req:type_name -> crane.grpc.StreamCallocRequest.TaskCompleteReq
	2,   // 59: crane.grpc.StreamCallocReply.type:type_name -> crane.grpc.StreamCallocReply.CforedReplyType
	111, // 60: crane.grpc.StreamCallocReply.payload_task_id_reply:type_name -> crane.grpc.StreamCallocReply.TaskIdReply
	112, // 61: crane.grpc.StreamCallocReply.payload_task_alloc_reply:type_name -> crane.grpc.StreamCallocReply.TaskResAllocatedReply
	113, // 62: crane.grpc.StreamCallocReply.payload_task_cancel_request:type_name -> crane.grpc.StreamCallocReply.TaskCancelRequest
	114, // 63: crane.grpc.StreamCallocReply.payload_task_completion_ack_reply:type_name -> crane.grpc.StreamCallocReply.TaskCompletionAckReply
	3,   // 64: crane.grpc.StreamCforedRequest.type:type_name -> crane.grpc.StreamCforedRequest.CforedRequestType
	115, // 65: crane.grpc.StreamCforedRequest.payload_cfored_reg:type_name -> crane.grpc.StreamCforedRequest.CforedReg
	116, // 66: crane.grpc.StreamCforedRequest.payload_task_req:type_name -> crane.grpc.StreamCforedRequest.TaskReq
	117, // 67: crane.grpc.StreamCforedRequest.payload_task_complete_req:type_name -> crane.grpc.StreamCforedRequest.TaskCompleteReq
	118, // 68: crane.grpc.StreamCforedRequest.payload_graceful_exit_req:type_name -> crane.grpc.StreamCforedRequest.GracefulExitReq
	4,   // 69: crane.grpc.StreamCtldReply.type:type_name -> crane.grpc.StreamCtldReply.CtldReplyType
	123, // 70: crane.grpc.StreamCtldReply.payload_cfored_reg_ack:type_name -> crane.grpc.StreamCtldReply.CforedRegistrationAck
	120, // 71: crane.grpc.StreamCtldReply.payload_task_res_alloc_reply:type_name -> crane.grpc.StreamCtldReply.TaskResAllocatedReply
	121, // 72: crane.grpc.StreamCtldReply.payload_task_cancel_request:type_name -> crane.grpc.StreamCtldReply.TaskCancelRequest
	122, // 73: crane.grpc.StreamCtldReply.payload_task_completion_ack:type_name -> crane.grpc.StreamCtldReply.TaskCompletionAckReply
	119, // 74: crane.grpc.StreamCtldReply.payload_task_id_reply:type_name -> crane.grpc.StreamCtldReply.TaskIdReply
	124, // 75: crane.grpc.StreamCtldReply.payload_graceful_exit_ack:type_name -> crane.grpc.StreamCtldReply.CforedGracefulExitAck
	146, // 76: crane.grpc.QueryCranedRemoteMetaReply.craned_remote_meta:type_name -> crane.grpc.CranedRemoteMeta
	5,   // 77: crane.grpc.StreamCrunRequest.type:type_name -> crane.grpc.StreamCrunRequest.CrunRequestType
	125, // 78: crane.grpc.StreamCrunRequest.payload_task_req:type_name -> crane.grpc.StreamCrunRequest.TaskReq
	126, // 79: crane.grpc.StreamCrunRequest.payload_task_complete_req:type_name -> crane.grpc.StreamCrunRequest.TaskCompleteReq
	127, // 80: crane.grpc.StreamCrunRequest.payload_task_io_forward_req:type_name -> crane.grpc.StreamCrunRequest.TaskIOForwardReq
	128, // 81: crane.grpc.StreamCrunRequest.payload_task_x11_forward_req:type_name -> crane.grpc.StreamCrunRequest.TaskX11ForwardReq
	6,   // 82: crane.grpc.StreamCrunReply.type:type_name -> crane.grpc.StreamCrunReply.CforedCrunReplyType
	129, // 83: crane.grpc.StreamCrunReply.payload_task_id_reply:type_name -> crane.grpc.StreamCrunReply.TaskIdReply
	130, // 84: crane.grpc.StreamCrunReply.payload_task_alloc_reply:type_name -> crane.grpc.StreamCrunReply.TaskResAllocatedReply
	131, // 85: crane.grpc.StreamCrunReply.payload_task_cancel_request:type_name -> crane.grpc.StreamCrunReply.TaskCancelRequest
	132, // 86: crane.grpc.StreamCrunReply.payload_task_completion_ack_reply:type_name -> crane.grpc.StreamCrunReply.TaskCompletionAckReply
	133, // 87: crane.grpc.StreamCrunReply.payload_task_io_forward_ready_reply:type_name -> crane.grpc.StreamCrunReply.TaskIOForwardReadyReply
	134, // 88: crane.grpc.StreamCrunReply.payload_task_io_forward_reply:type_name -> crane.grpc.StreamCrunReply.TaskIOForwardReply
	135, // 89: crane.grpc.StreamCrunReply.payload_task_x11_forward_reply:type_name -> crane.grpc.StreamCrunReply.TaskX11ForwardReply
	7,   // 90: crane.grpc.StreamTaskIORequest.type:type_name -> crane.grpc.StreamTaskIORequest.CranedRequestType
	136, // 91: crane.grpc.StreamTaskIORequest.payload_register_req:type_name -> crane.grpc.StreamTaskIORequest.CranedRegisterReq
	137, // 92: crane.grpc.StreamTaskIORequest.payload_task_output_req:type_name -> crane.grpc.StreamTaskIORequest.CranedTaskOutputReq
	138, // 93: crane.grpc.StreamTaskIORequest.payload_unregister_req:type_name -> crane.grpc.StreamTaskIORequest.CranedUnRegisterReq
	139, // 94: crane.grpc.StreamTaskIORequest.payload_task_x11_output_req:type_name -> crane.grpc.StreamTaskIORequest.CranedTaskX11OutputReq
	8,   // 95: crane.grpc.StreamTaskIOReply.type:type_name -> crane.grpc.StreamTaskIOReply.CranedReplyType
	140, // 96: crane.grpc.StreamTaskIOReply.payload_craned_register_reply:type_name -> crane.grpc.StreamTaskIOReply.CranedRegisterReply
	141, // 97: crane.grpc.StreamTaskIOReply.payload_task_input_req:type_name -> crane.grpc.StreamTaskIOReply.CranedTaskInputReq
	142, // 98: crane.grpc.StreamTaskIOReply.payload_craned_unregister_reply:type_name -> crane.grpc.StreamTaskIOReply.CranedUnregisterReply
	143, // 99: crane.grpc.StreamTaskIOReply.payload_task_x11_input_req:type_name -> crane.grpc.StreamTaskIOReply.CranedTaskX11InputReq
	163, // 100: crane.grpc.PowerStateChangeRequest.state:type_name -> crane.grpc.CranedPowerState
	150, // 101: crane.grpc.ConfigureCranedRequest.JobMapEntry.value:type_name -> crane.grpc.JobToD
	149, // 102: crane.grpc.ConfigureCranedRequest.JobTasksMapEntry.value:type_name -> crane.grpc.TaskToD
	147, // 103: crane.grpc.StreamCallocRequest.TaskReq.task:type_name -> crane.grpc.TaskToCtld
	144, // 104: crane.grpc.StreamCallocRequest.TaskCompleteReq.status:type_name -> crane.grpc.TaskStatus
	147, // 105: crane.grpc.StreamCforedRequest.TaskReq.task:type_name -> crane.grpc.TaskToCtld
	144, // 106: crane.grpc.StreamCforedRequest.TaskCompleteReq.status:type_name -> crane.grpc.TaskStatus
	167, // 107: crane.grpc.StreamCforedRequest.TaskCompleteReq.interactive_type:type_name -> crane.grpc.InteractiveTaskType
	147, // 108: crane.grpc.StreamCrunRequest.TaskReq.task:type_name -> crane.grpc.TaskToCtld
	144, // 109: crane.grpc.StreamCrunRequest.TaskCompleteReq.status:type_name -> crane.grpc.TaskStatus
	33,  // 110: crane.grpc.CraneCtld.CancelTask:input_type -> crane.grpc.CancelTaskRequest
	17,  // 111: crane.grpc.CraneCtld.SubmitBatchTask:input_type -> crane.grpc.SubmitBatchTaskRequest
	19,  // 112: crane.grpc.CraneCtld.SubmitBatchTasks:input_type -> crane.grpc.SubmitBatchTasksRequest
	39,  // 113: crane.grpc.CraneCtld.QueryCranedInfo:input_type -> crane.grpc.QueryCranedInfoRequest
	41,  // 114: crane.grpc.CraneCtld.QueryPartitionInfo:input_type -> crane.grpc.QueryPartitionInfoRequest
	43,  // 115: crane.grpc.CraneCtld.QueryReservationInfo:input_type -> crane.grpc.QueryReservationInfoRequest
	45,  // 116: crane.grpc.CraneCtld.ModifyTask:input_type -> crane.grpc.ModifyTaskRequest
	47,  // 117: crane.grpc.CraneCtld.ModifyNode:input_type -> crane.grpc.ModifyCranedStateRequest
	75,  // 118: crane.grpc.CraneCtld.ModifyPartitionAcl:input_type -> crane.grpc.ModifyPartitionAclRequest
	103, // 119: crane.grpc.CraneCtld.EnableAutoPowerControl:input_type -> crane.grpc.EnableAutoPowerControlRequest
	49,  // 120: crane.grpc.CraneCtld.AddAccount:input_type -> crane.grpc.AddAccountRequest
	51,  // 121: crane.grpc.CraneCtld.AddUser:input_type -> crane.grpc.AddUserRequest
	53,  // 122: crane.grpc.CraneCtld.AddQos:input_type -> crane.grpc.AddQosRequest
	55,  // 123: crane.grpc.CraneCtld.DeleteAccount:input_type -> crane.grpc.DeleteAccountRequest
	57,  // 124: crane.grpc.CraneCtld.DeleteUser:input_type -> crane.grpc.DeleteUserRequest
	59,  // 125: crane.grpc.CraneCtld.DeleteQos:input_type -> crane.grpc.DeleteQosRequest
	67,  // 126: crane.grpc.CraneCtld.QueryAccountInfo:input_type -> crane.grpc.QueryAccountInfoRequest
	69,  // 127: crane.grpc.CraneCtld.QueryUserInfo:input_type -> crane.grpc.QueryUserInfoRequest
	71,  // 128: crane.grpc.CraneCtld.QueryQosInfo:input_type -> crane.grpc.QueryQosInfoRequest
	61,  // 129: crane.grpc.CraneCtld.ModifyAccount:input_type -> crane.grpc.ModifyAccountRequest
	63,  // 130: crane.grpc.CraneCtld.ModifyUser:input_type -> crane.grpc.ModifyUserRequest
	65,  // 131: crane.grpc.CraneCtld.ModifyQos:input_type -> crane.grpc.ModifyQosRequest
	73,  // 132: crane.grpc.CraneCtld.BlockAccountOrUser:input_type -> crane.grpc.BlockAccountOrUserRequest
	83,  // 133: crane.grpc.CraneCtld.QueryClusterInfo:input_type -> crane.grpc.QueryClusterInfoRequest
	85,  // 134: crane.grpc.CraneCtld.QueryTasksInfo:input_type -> crane.grpc.QueryTasksInfoRequest
	87,  // 135: crane.grpc.CraneCtld.CreateReservation:input_type -> crane.grpc.CreateReservationRequest
	89,  // 136: crane.grpc.CraneCtld.DeleteReservation:input_type -> crane.grpc.DeleteReservationRequest
	101, // 137: crane.grpc.CraneCtld.PowerStateChange:input_type -> crane.grpc.PowerStateChangeRequest
	9,   // 138: crane.grpc.CraneCtldForInternal.TaskStatusChange:input_type -> crane.grpc.TaskStatusChangeRequest
	11,  // 139: crane.grpc.CraneCtldForInternal.CranedTriggerReverseConn:input_type -> crane.grpc.CranedTriggerReverseConnRequest
	13,  // 140: crane.grpc.CraneCtldForInternal.CranedRegister:input_type -> crane.grpc.CranedRegisterRequest
	93,  // 141: crane.grpc.CraneCtldForInternal.CforedStream:input_type -> crane.grpc.StreamCforedRequest
	12,  // 142: crane.grpc.Craned.Configure:input_type -> crane.grpc.ConfigureCranedRequest
	21,  // 143: crane.grpc.Craned.ExecuteTask:input_type -> crane.grpc.ExecuteTasksRequest
	23,  // 144: crane.grpc.Craned.CreateCgroupForTasks:input_type -> crane.grpc.CreateCgroupForTasksRequest
	25,  // 145: crane.grpc.Craned.ReleaseCgroupForTasks:input_type -> crane.grpc.ReleaseCgroupForTasksRequest
	27,  // 146: crane.grpc.Craned.TerminateTasks:input_type -> crane.grpc.TerminateTasksRequest
	29,  // 147: crane.grpc.Craned.TerminateOrphanedTask:input_type -> crane.grpc.TerminateOrphanedTaskRequest
	31,  // 148: crane.grpc.Craned.ChangeTaskTimeLimit:input_type -> crane.grpc.ChangeTaskTimeLimitRequest
	35,  // 149: crane.grpc.Craned.QueryTaskIdFromPort:input_type -> crane.grpc.QueryTaskIdFromPortRequest
	79,  // 150: crane.grpc.Craned.QueryTaskEnvVariables:input_type -> crane.grpc.QueryTaskEnvVariablesRequest
	37,  // 151: crane.grpc.CranedForPam.QueryTaskIdFromPortForward:input_type -> crane.grpc.QueryTaskIdFromPortForwardRequest
	77,  // 152: crane.grpc.CranedForPam.MigrateSshProcToCgroup:input_type -> crane.grpc.MigrateSshProcToCgroupRequest
	81,  // 153: crane.grpc.CranedForPam.QueryTaskEnvVariablesForward:input_type -> crane.grpc.QueryTaskEnvVariablesForwardRequest
	91,  // 154: crane.grpc.CraneForeD.CallocStream:input_type -> crane.grpc.StreamCallocRequest
	97,  // 155: crane.grpc.CraneForeD.CrunStream:input_type -> crane.grpc.StreamCrunRequest
	99,  // 156: crane.grpc.CraneForeD.TaskIOStream:input_type -> crane.grpc.StreamTaskIORequest
	35,  // 157: crane.grpc.CraneForeD.QueryTaskIdFromPort:input_type -> crane.grpc.QueryTaskIdFromPortRequest
	...
	104, // 167: crane.grpc.CraneCtld.EnableAutoPowerControl:output_type -> crane.grpc.EnableAutoPowerControlReply
	50,  // 168: crane.grpc.CraneCtld.AddAccount:output_type -> crane.grpc.AddAccountReply
	52,  // 169: crane.grpc.CraneCtld.AddUser:output_type -> crane.grpc.AddUserReply
	54,  // 170: crane.grpc.CraneCtld.AddQos:output_type -> crane.grpc.AddQosReply
	56,  // 171: crane.grpc.CraneCtld.DeleteAccount:output_type -> crane.grpc.DeleteAccountReply
	58,  // 172: crane.grpc.CraneCtld.DeleteUser:output_type -> crane.grpc.DeleteUserReply
	60,  // 173: crane.grpc.CraneCtld.DeleteQos:output_type -> crane.grpc.DeleteQosReply
	68,  // 174: crane.grpc.CraneCtld.QueryAccountInfo:output_type -> crane.grpc.QueryAccountInfoReply
	70,  // 175: crane.grpc.CraneCtld.QueryUserInfo:output_type -> crane.grpc.QueryUserInfoReply
	72,  // 176: crane.grpc.CraneCtld.QueryQosInfo:output_type -> crane.grpc.QueryQosInfoReply
	62,  // 177: crane.grpc.CraneCtld.ModifyAccount:output_type -> crane.grpc.ModifyAccountReply
	64,  // 178: crane.grpc.CraneCtld.ModifyUser:output_type -> crane.grpc.ModifyUserReply
	66,  // 179: crane.grpc.CraneCtld.ModifyQos:output_type -> crane.grpc.ModifyQosReply
	74,  // 180: crane.grpc.CraneCtld.BlockAccountOrUser:output_type -> crane.grpc.BlockAccountOrUserReply
	84,  // 181: crane.grpc.CraneCtld.QueryClusterInfo:output_type -> crane.grpc.QueryClusterInfoReply
	86,  // 182: crane.grpc.CraneCtld.QueryTasksInfo:output_type -> crane.grpc.QueryTasksInfoReply
	88,  // 183: crane.grpc.CraneCtld.CreateReservation:output_type -> crane.grpc.CreateReservationReply
	90,  // 184: crane.grpc.CraneCtld.DeleteReservation:output_type -> crane.grpc.DeleteReservationReply
	102, // 185: crane.grpc.CraneCtld.PowerStateChange:output_type -> crane.grpc.PowerStateChangeReply
	10,  // 186: crane.grpc.CraneCtldForInternal.TaskStatusChange:output_type -> crane.grpc.TaskStatusChangeReply
	168, // 187: crane.grpc.CraneCtldForInternal.CranedTriggerReverseConn:output_type -> google.protobuf.Empty
	14,  // 188: crane.grpc.CraneCtldForInternal.CranedRegister:output_type -> crane.grpc.CranedRegisterReply
	94,  // 189: crane.grpc.CraneCtldForInternal.CforedStream:output_type -> crane.grpc.StreamCtldReply
	168, // 190: crane.grpc.Craned.Configure:output_type -> google.protobuf.Empty
	22,  // 191: crane.grpc.Craned.ExecuteTask:output_type -> crane.grpc.ExecuteTasksReply
	24,  // 192: crane.grpc.Craned.CreateCgroupForTasks:output_type -> crane.grpc.CreateCgroupForTasksReply
	26,  // 193: crane.grpc.Craned.ReleaseCgroupForTasks:output_type -> crane.grpc.ReleaseCgroupForTasksReply
	28,  // 194: crane.grpc.Craned.TerminateTasks:output_type -> crane.grpc.TerminateTasksReply
	30,  // 195: crane.grpc.Craned.TerminateOrphanedTask:output_type -> crane.grpc.TerminateOrphanedTaskReply
	32,  // 196: crane.grpc.Craned.ChangeTaskTimeLimit:output_type -> crane.grpc.ChangeTaskTimeLimitReply
	36,  // 197: crane.grpc.Craned.QueryTaskIdFromPort:output_type -> crane.grpc.QueryTaskIdFromPortReply
	80,  // 198: crane.grpc.Craned.QueryTaskEnvVariables:output_type -> crane.grpc.QueryTaskEnvVariablesReply
	38,  // 199: crane.grpc.CranedForPam.QueryTaskIdFromPortForward:output_type -> crane.grpc.QueryTaskIdFromPortForwardReply
	78,  // 200: crane.grpc.CranedForPam.MigrateSshProcToCgroup:output_type -> crane.grpc.MigrateSshProcToCgroupReply
	82,  // 201: crane.grpc.CranedForPam.QueryTaskEnvVariablesForward:output_type -> crane.grpc.QueryTaskEnvVariablesForwardReply
	92,  // 202: crane.grpc.CraneForeD.CallocStream:output_type -> crane.grpc.StreamCallocReply
	98,  // 203: crane.grpc.CraneForeD.CrunStream:output_type -> crane.grpc.StreamCrunReply
	100, // 204: crane.grpc.CraneForeD.TaskIOStream:output_type -> crane.grpc.StreamTaskIOReply
	36,  // 205: crane.grpc.CraneForeD.QueryTaskIdFromPort:output_type -> crane.grpc.QueryTaskIdFromPortReply
