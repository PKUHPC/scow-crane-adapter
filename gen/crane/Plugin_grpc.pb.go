...
const (
	...
	CranePluginD_UpdateLicensesHook_FullMethodName   = "/crane.grpc.plugin.CranePluginD/UpdateLicensesHook"
...
type CranePluginDClient interface {
	...
	UpdateLicensesHook(ctx context.Context, in *UpdateLicensesHookRequest, opts ...grpc.CallOption) (*UpdateLicensesHookReply, error)
	// ----------------------------------- Called from Craned ----------------------------------------------------
...
func (c *cranePluginDClient) NodeEventHook(ctx context.Context, in *NodeEventHookRequest, opts ...grpc.CallOption) (*NodeEventHookReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(NodeEventHookReply)
	err := c.cc.Invoke(ctx, CranePluginD_NodeEventHook_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cranePluginDClient) UpdateLicensesHook(ctx context.Context, in *UpdateLicensesHookRequest, opts ...grpc.CallOption) (*UpdateLicensesHookReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdateLicensesHookReply)
	err := c.cc.Invoke(ctx, CranePluginD_UpdateLicensesHook_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// All implementations should embed UnimplementedCranePluginDServer
...
type CranePluginDServer interface {
	...
	UpdateLicensesHook(context.Context, *UpdateLicensesHookRequest) (*UpdateLicensesHookReply, error)
	// ----------------------------------- Called from Craned ----------------------------------------------------
...
// UnimplementedCranePluginDServer should be embedded to have
...
func (UnimplementedCranePluginDServer) StartHook(context.Context, *StartHookRequest) (*StartHookReply, error) {
	return nil, status.Error(codes.Unimplemented, "method StartHook not implemented")
}
func (UnimplementedCranePluginDServer) EndHook(context.Context, *EndHookRequest) (*EndHookReply, error) {
	return nil, status.Error(codes.Unimplemented, "method EndHook not implemented")
}
func (UnimplementedCranePluginDServer) NodeEventHook(context.Context, *NodeEventHookRequest) (*NodeEventHookReply, error) {
	return nil, status.Error(codes.Unimplemented, "method NodeEventHook not implemented")
}
func (UnimplementedCranePluginDServer) UpdatePowerStateHook(context.Context, *UpdatePowerStateHookRequest) (*UpdatePowerStateHookReply, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdatePowerStateHook not implemented")
}
func (UnimplementedCranePluginDServer) RegisterCranedHook(context.Context, *RegisterCranedHookRequest) (*RegisterCranedHookReply, error) {
	return nil, status.Error(codes.Unimplemented, "method RegisterCranedHook not implemented")
}
func (UnimplementedCranePluginDServer) UpdateLicensesHook(context.Context, *UpdateLicensesHookRequest) (*UpdateLicensesHookReply, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateLicensesHook not implemented")
}
func (UnimplementedCranePluginDServer) CreateCgroupHook(context.Context, *CreateCgroupHookRequest) (*CreateCgroupHookReply, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateCgroupHook not implemented")
}
func (UnimplementedCranePluginDServer) DestroyCgroupHook(context.Context, *DestroyCgroupHookRequest) (*DestroyCgroupHookReply, error) {
	return nil, status.Error(codes.Unimplemented, "method DestroyCgroupHook not implemented")
}
...
func RegisterCranePluginDServer(s grpc.ServiceRegistrar, srv CranePluginDServer) {
	// If the following call panics, it indicates UnimplementedCranePluginDServer was
...
func _CranePluginD_NodeEventHook_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(NodeEventHookRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CranePluginDServer).NodeEventHook(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CranePluginD_NodeEventHook_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CranePluginDServer).NodeEventHook(ctx, req.(*NodeEventHookRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _CranePluginD_UpdateLicensesHook_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateLicensesHookRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CranePluginDServer).UpdateLicensesHook(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CranePluginD_UpdateLicensesHook_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CranePluginDServer).UpdateLicensesHook(ctx, req.(*UpdateLicensesHookRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CranePluginD_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateLicensesHook",
			Handler:    _CranePluginD_UpdateLicensesHook_Handler,
		},
		{
